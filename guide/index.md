...
description: "How to diagnose what's going wrong in PNW vegetable, fruit, and ornamental gardens — a symptom-first cheat sheet for the most common Pacific Northwest plant problems."
permalink: /guide/
---
...
This guide covers the most common diagnoses for Pacific Northwest vegetable, fruit, and ornamental gardens — organized by what you're seeing, with cross-references to the underlying cause categories. For PNW-specific growing notes (when to plant, what varieties work, common problems by plant), see the [plant guide](/plants/). Save this one. You'll come back.
...
4. [The easy way](#part-3)

For PNW plant-specific growing notes, see the [plant guide](/plants/).
...
## Part 1 — Diagnose by symptom {#part-1}

The fastest way to narrow down what's wrong is to start with what you can see. Most plant problems present as one of about eight visible symptoms — yellowing, browning, wilting, holes, spots, curling, stunting, or refusing to flower. Each of those points back to a smaller set of likely causes, and a few quick observations are usually enough to identify the most probable one.

This section walks through each symptom: what it looks like, what's most often behind it, and the first thing to check before you reach for a treatment. The cause categories themselves — what nitrogen deficiency actually does, how to recognize fungal disease, how watering and weather and pests interact — are covered in [Part 2](#part-2).

### Yellow leaves {#yellow}

Yellow leaves are the single most-Googled plant problem, and the answer almost always depends on three things: which leaves are yellow, how fast it happened, and whether anything else is wrong. A tomato shedding a single bottom leaf is fine. A whole pepper plant going pale in two days is not.
...
If pieces of your plant are missing, something is eating it. The size and shape of the damage, plus what's left behind, will narrow it down to one or two suspects faster than any other symptom.
