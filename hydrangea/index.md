---
layout: guide
title: "Growing Hydrangeas in the Pacific Northwest"
description: "How to grow hydrangeas in the PNW: bloom color and soil pH, when to prune (the make-or-break decision), and which type of hydrangea you actually have."
permalink: /hydrangea/
---
...
- **[Rhododendron](/rhododendron)** — same general conditions; similar shade tolerance
- **Hostas, ferns, astilbes** — classic shade-garden companions
- **Japanese maples** — common partner in PNW gardens

For underlying patterns affecting hydrangeas (water management, pH, pruning timing), see [the diagnosis guide](/guide).
