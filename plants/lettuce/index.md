---
layout: guide
title: "Growing Lettuce in the Pacific Northwest"
description: "How to grow lettuce in the PNW: when to plant for spring and fall, why summer is tough, the slug problem every PNW gardener has, and varieties that handle our long cool seasons."
permalink: /lettuce/
---
...
- **[Kale](/kale)** — similar cool-season profile, much more heat-tolerant
- **Spinach, arugula, chard** — all share lettuce's spring/fall window
- **Carrots, radishes** — quick companions that interplant well

For underlying patterns affecting lettuce (heat stress, slug pressure, watering), see [the diagnosis guide](/guide).
