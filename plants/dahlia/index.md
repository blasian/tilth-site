---
layout: guide
title: "Growing Dahlias in the Pacific Northwest"
description: "How to grow dahlias in the PNW: when to plant tubers, slug protection at sprout time (the make-or-break decision), and whether to lift or leave tubers over winter."
permalink: /dahlia/
---
...
- **[Hydrangea](/hydrangea)** — different cultivation but flowers in the same window
- **Salvia, snapdragons** — companion border plants

For underlying patterns affecting dahlias (slugs, drainage, bloom failure), see [the diagnosis guide](/guide).
