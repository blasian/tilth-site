---
layout: guide
title: "Growing Cucumbers in the Pacific Northwest"
description: "How to grow cucumbers in the PNW: when to plant, why pickling varieties beat slicers in cool summers, and how to handle the powdery and downy mildew that show up reliably here."
permalink: /cucumber/
---
...
- **[Squash & zucchini](/squash)** — same family (Cucurbitaceae), similar mildew problems
- **Beans** — companion plant, doesn't compete heavily for soil nutrients
- **Dill, basil** — herbal companions that may deter some pests

For the underlying patterns affecting cucumbers (water consistency, mildew prevention), see [the diagnosis guide](/guide).
