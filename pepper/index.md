---
layout: guide
title: "Growing Peppers in the Pacific Northwest"
description: "How to grow peppers in the PNW: when to plant, why bell peppers struggle here, what varieties actually produce, and how to add the heat peppers need to thrive."
permalink: /pepper/
---
...
- **[Tomato](/tomato)** — same family (Solanaceae), similar growing approach
- **[Eggplant](#)** — same family, even more cold-sensitive than peppers
- **Basil** — companion plant, similar conditions

For underlying patterns affecting peppers (cool-soil stalls, flower drop, pest pressure), see [the diagnosis guide](/guide).
