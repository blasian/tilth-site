---
layout: guide
title: "Growing Tomatoes in the Pacific Northwest"
description: "How to grow tomatoes in the PNW: when to plant, what varieties actually finish in cool summers, sun and water needs, and the common problems to watch for."
permalink: /tomato/
---
...
- **Sungold** (60 days) — cherry, heavy producer, almost foolproof. The default PNW tomato.
- **Sun Sugar** (62 days) — yellow cherry, similar to Sungold but a touch sweeter
- **Stupice** (55 days) — Czech heirloom, small slicer, very early, prolific
- **Early Girl** (50 days) — red slicer, reliable workhorse
- **Black Cherry** (65 days) — flavorful purple-black cherry
- **Cherokee Purple** (75 days) — large dark heirloom, finishes in good years with a south-facing spot
- **Brandywine** (80 days) — risky in PNW; only attempt with a hot summer and a sheltered position
- **Beefsteak / Mortgage Lifter / most Italian types** — skip. They won't finish.
...
- **[Pepper](/pepper)** — same family (Solanaceae), similar requirements but even more cold-sensitive
- **[Squash & zucchini](/squash)** — different family but competes for the same warm-season bed space
- **Basil** — classic companion, loves the same heat and water schedule
- **Marigold** — companion plant; may help repel some pests

For the underlying watering, nutrient, and disease patterns that affect tomatoes (and most other vegetables), see [the diagnosis guide](/guide).
